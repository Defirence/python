...
class SchrödingerBoxGUI:
    ...
    def _set_box(self):
        ...
        try:
            # Evaluate amplitudes to allow complex numbers (e.g., '1j', '0.5+0.5j')
            amplitudes_raw = [eval(a.strip()) for a in amplitudes_str.split(',') if a.strip()]
        ...
        try:
            self.schrodinger_box = SchrödingersBox(states_amplitudes_dict)
...
if __name__ == "__main__":
    ...
    try:
        ...
        app = SchrödingerBoxGUI(root)
        print("SchrödingerBoxGUI instance created.")
        root.mainloop()
